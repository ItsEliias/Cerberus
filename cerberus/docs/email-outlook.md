...
Cerberus email accounts currently use IMAP and SMTP with username/password
...
This is expected. Cerberus does not support Microsoft OAuth or Graph Mail yet,
