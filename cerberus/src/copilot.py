...
COPILOT_USER_AGENT = os.environ.get(
    "CERBERUS_COPILOT_USER_AGENT", "Cerberus/1.0"
)
COPILOT_INTEGRATION_ID = os.environ.get(
    "CERBERUS_COPILOT_INTEGRATION_ID", "vscode-chat"
)
COPILOT_EDITOR_VERSION = os.environ.get(
    "CERBERUS_COPILOT_EDITOR_VERSION", "Cerberus/1.0"
)
