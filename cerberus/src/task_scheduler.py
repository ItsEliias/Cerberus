...
class TaskScheduler:
    ...
    async def _deliver_via_email(self, output: str, task, result: str):
        ...
        try:
            ...
            msg["X-Cerberus-Origin"] = "cerberus-ui"
            msg["X-Cerberus-Kind"] = "task"
            msg["X-Cerberus-Ref"] = str(task.id)
    ...
    async def _deliver_via_mcp(self, tool_name: str, task, result: str):
        ...
        args = {
            ...
            "body": result,
            "headers": {
                "X-Cerberus-Origin": "cerberus-ui",
                "X-Cerberus-Kind": "task",
                "X-Cerberus-Ref": str(task.id),
            },
        }
        if recipient:
