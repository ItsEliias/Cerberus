...
class MemoryManager:
    ...
    def load(self, owner: str = None, agent_id: str = None) -> List[Dict]:
        """Load memory entries, optionally filtered by owner and/or agent_id."""
    ...
    def add_entry(self, text: str, source: str = "user", category: str = "fact", owner: str = None, agent_id: str = None) -> Dict:
