...
const EMAIL_DOC_SPLIT_WIDTH_KEY = 'cerberus-email-doc-split-width';
const EDGE_DOCK_WIDTH_KEY_PREFIX = 'cerberus-edge-dock-width';
...
(function _initEdgeDockResizeHandles() {
  ...
  window.addEventListener('cerberus:modal-opened', _positionEdgeDockResizeHandles);
  _positionEdgeDockResizeHandles();
})();
