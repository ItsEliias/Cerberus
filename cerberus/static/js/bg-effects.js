// bg-effects.js — Cerberus animated background engine (CANONICAL SOURCE).
//
// Extracted verbatim from theme.js so it can be shared with CyberDeck without
// duplication. theme.js imports the apply* fns back from here; nothing else in
// this file depends on theme.js internals (only DOM + the --bg-effect-* CSS vars).
// Downstream (CyberDeck) syncs this file via scripts/sync-shared.sh.
