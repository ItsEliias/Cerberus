...
// ── Key constants ──
export const KEYS = {
  THEME: 'cerberus-theme',
  TOGGLES: 'cerberus-toggles',
  ...
  MODELS_EXPANDED: 'cerberus-model-expanded',
  MODEL_ENDPOINTS: 'cerberus-model-endpoints',
  MODEL_SELECTED: 'cerberus-selected-model',
  SORT_ORDER: 'cerberus-sessions-sort',
  CHAT_SEARCH_SCOPE: 'cerberus-search-scope',
  INCOGNITO: 'cerberus-incognito',
  RAG_ACTIVE: 'cerberus-rag-active',
  MCP_ACTIVE: 'cerberus-mcp-active',
  SECTION_ORDER: 'sidebar-section-order',
  ADMIN_LAST_TAB: 'admin-last-tab',
  DENSITY: 'cerberus-density'
};
