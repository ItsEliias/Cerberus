...
import { applyBgPattern, applyBgEffectColor, applyBgEffectIntensity, applyBgEffectSize, applyFrostedGlass } from './bg-effects.js';
...
// Background-effect engine lives in ./bg-effects.js (shared with CyberDeck).
