...
function initMermaid() {
  if (!window.mermaid || window.__cerberusMermaidReady) return;
  window.mermaid.initialize({ startOnLoad: false, theme: 'dark', securityLevel: 'loose' });
  window.__cerberusMermaidReady = true;
}
window.cerberusInitMermaid = initMermaid;
initMermaid();
...
const THINK_EXPANDED_KEY = 'cerberus-thinking-expanded';
