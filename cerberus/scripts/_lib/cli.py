"""scripts/_lib/cli.py — shared scaffolding for the `cerberus-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("cerberus-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/cerberus-foo`
...
VERSION = "0.1.0"  # bumped centrally; every cerberus-* CLI reports this
