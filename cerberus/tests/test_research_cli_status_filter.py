"""`cerberus-research list --status complete` was returning nothing.
...
Part of #2122 (cerberus-* CLI list/search bugs).
"""
...
def _load_cli():
    path = ROOT / "scripts" / "cerberus-research"
    loader = importlib.machinery.SourceFileLoader("cerberus_research_cli", str(path))
