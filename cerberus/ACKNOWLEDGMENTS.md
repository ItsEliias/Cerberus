...
## Cerberus additions (Phase 1, 2026)

Cerberus is a security-hardened fork of odysseus. The following upstream
projects were vendored or integrated as part of the Cerberus build:

| Project | License | Role |
|---------|---------|------|
| [odysseus](https://github.com/pewdiepie-archdaemon/odysseus) | AGPL-3.0 | Backbone (chat, agent loop, docs, email, calendar, web UI) |
| [OpenSandbox](https://github.com/opensandbox-group/OpenSandbox) | Apache-2.0 | Agent sandbox (isolates shell/code execution from host) |
| [hermes-agent](https://github.com/NousResearch/hermes-agent) | MIT | Connectivity gateway (Telegram, Slack, Discord) |

Full license texts for all three are in `THIRD_PARTY_LICENSES.md`.
Pinned SHAs are in `PROVENANCE.md`.

---

## Original odysseus acknowledgments
