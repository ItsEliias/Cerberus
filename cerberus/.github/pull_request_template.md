...
- [ ] I searched [open issues](https://github.com/pewdiepie-archdaemon/cerberus/issues) and [open PRs](https://github.com/pewdiepie-archdaemon/cerberus/pulls) — this is not a duplicate.
- [ ] This PR targets `dev`
...
- [ ] **Style match**: the change uses Cerberus's existing visual language. Specifically:
